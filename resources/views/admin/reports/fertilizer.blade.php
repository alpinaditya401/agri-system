<x-layouts.app :title="'Laporan Distribusi Pupuk – Agrilink'">
    <x-slot:sidebar>
        @include('admin._sidebar')
    </x-slot:sidebar>

    <x-slot:header>
        <h1 class="text-lg font-bold text-gray-800">Laporan Distribusi Pupuk</h1>
    ...
    <form method="GET" class="flex flex-wrap gap-2 mb-5">
        ...
        <a href="{{ route('admin.reports.fertilizer.export', request()->query()) }}" class="inline-flex items-center rounded-xl bg-emerald-600 px-4 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-emerald-700">
            Export CSV
        </a>
    </form>
