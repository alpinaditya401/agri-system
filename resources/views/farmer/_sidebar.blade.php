...
<a href="{{ route('farmer.produk.index') }}" class="sidebar-link {{ request()->routeIs('farmer.produk.*') ? 'active' : '' }}">
    ...
    <span class="whitespace-nowrap">Produk Saya</span>
</a>
<a href="{{ route('farmer.orders.index') }}" class="sidebar-link {{ request()->routeIs('farmer.orders.*') ? 'active' : '' }}">
    ...
    <span class="whitespace-nowrap">Pesanan Masuk</span>
</a>
<a href="{{ route('farmer.fertilizer.index') }}" class="sidebar-link {{ request()->routeIs('farmer.fertilizer.*') ? 'active' : '' }}">
    ...
    <span class="whitespace-nowrap">Pengajuan Subsidi</span>
</a>
